...
<script>
// @ is an alias to /src
import HeaderWormth from "../components/HeaderWormth.vue";
import FooterWormth from "../components/FooterWormth.vue";
import RelatedProductWormth from "../components/RelatedProductWormth.vue";
